  ...
  <div>
    <v-row>
      <v-col cols="12">
        ...
        <img v-else :src="defaultImg.url" :alt="defaultImg.alt" width="100%" />
      </v-col>
      <v-col cols="12" class="text-center">
        <v-row align="center" justify="center">
          <admin-modals-upload-image :image.sync="postImage" />
          <admin-modals-select-image :item.sync="postImage" :images="images" />
        </v-row>
      </v-col>
    </v-row>
  </div>
...
export default {
  ...
  computed: {
    images() {
      return this.$store.getters['images/allImages']
    },
  },
  watch: {
